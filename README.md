...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-sphinx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10485&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-sphinx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-sphinx` can be installed with:

```
conda install jupyter-sphinx
```

It is possible to list all of the versions of `jupyter-sphinx` available on your platform with:
